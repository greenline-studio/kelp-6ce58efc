    ...
    <div className="relative space-y-4">
      ...
      {stops.map((stop, index) => (
        ...
        >
          ...
          {/* Card */}
          <div className="ml-16 glass-card overflow-hidden group hover:glow-primary transition-all duration-300">
            {/* Image section */}
            {stop.imageUrl && (
              <div className="relative h-32 overflow-hidden">
                ...
                <div className="absolute top-3 right-3 flex items-center gap-2">
                  ...
                  <span className="px-2 py-1 rounded-full bg-background/80 backdrop-blur-sm text-sm font-medium">
                    {stop.price}
                  </span>
                </div>
              </div>
            ...
            <div className="p-5">
              <div className="flex items-start justify-between mb-2">
                ...
                {/* Show rating/price here if no image */}
                {!stop.imageUrl && (
